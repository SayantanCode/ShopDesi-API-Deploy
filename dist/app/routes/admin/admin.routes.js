...
router.post("/auth/update-password", auth.verifyAdminToken, adminController.changePassword);
router.get("/auth/profile", auth.verifyAdminToken, adminController.getProfile);
router.post("/auth/update-profile", auth.verifyAdminToken, handleUpload, adminController.updateProfile);
